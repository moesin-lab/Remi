...
| ACP provider | [adapter registry](../packages/acp/src/adapters/index.ts)、[provisioning](../packages/acp/src/provision.ts) | 当前注册 Claude、Codex、Grok；需要对应认证，平台注册不证明 provider 可运行 | [provider 测试](../tests/unit/acp/providers.test.ts)、[真实冒烟](../tests/integration/smoke-multiremi-acp.ts) |
