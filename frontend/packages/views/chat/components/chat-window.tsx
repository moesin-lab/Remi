...
export function ChatWindow({
  ...
  const [runtimeWorkspaceId, setRuntimeWorkspaceId] = useState<string | null>(
    null,
  );
    ...
    <>
      ...
      <div className="shrink-0 border-b px-3 py-2">
        <WorkLocationPicker
          ...
          value={
            activeSessionId
              ? (currentSession?.runtime_workspace_id ?? null)
              : runtimeWorkspaceId
          }
          projectId={
            activeSessionId ? (currentSession?.project_id ?? null) : projectId
          }
          onChange={(location) => {
