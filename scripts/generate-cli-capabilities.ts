...
const DOMAIN_ALIASES: Record<string, string> = {
  ...
  install: "lark",
  models: "runtime",
  "execution-groups": "runtime",
  "execution-profiles": "runtime",
  "project-docs": "wiki",
...
function mappedResourceCommand(route: string): string | null {
  ...
  const rules: Array<[RegExp, string]> = [
    ...
    [/^POST \/api\/workspaces\/:id\/repos\/:repositoryId\/wiki\/repair-log$/, "wiki.repository.repair-log"],
    [/^POST \/api\/workspaces\/:id\/repos\/:repositoryId\/wiki\/outcome$/, "wiki.repository.outcome"],
    ...
    [/^PATCH \/api\/chat\/sessions\/:sessionId\/queue\/:taskId$/, "chat.queue.update"],
    [/^DELETE \/api\/chat\/sessions\/:sessionId\/queue\/:taskId$/, "chat.queue.remove"],
    [/^DELETE \/api\/chat\/sessions\/:sessionId\/queue$/, "chat.queue.clear"],
    [/^POST \/api\/chat\/sessions\/:sessionId\/queue\/:taskId\/prioritize$/, "chat.queue.prioritize"],
...
function mappedOperationsCommand(route: string): string | null {
  const exact: Record<string, string> = {
    ...
    "GET /api/execution-groups/:id": "runtime.group.get",
    "POST /api/execution-groups": "runtime.group.create",
    "PUT /api/execution-groups/:id": "runtime.group.update",
    "DELETE /api/execution-groups/:id": "runtime.group.delete",
    "GET /api/execution-profiles/:id": "runtime.profile.get",
    "POST /api/execution-profiles": "runtime.profile.create",
    "PUT /api/execution-profiles/:id": "runtime.profile.update",
    "DELETE /api/execution-profiles/:id": "runtime.profile.delete",
    "GET /api/execution-profiles": "runtime.profile.list",
  ...
  const rules: Array<[RegExp, string]> = [
    ...
    [/^GET \/api\/runtimes\/:id\/claude-profile$/, "runtime.claude-profile.get"],
    [/^PUT \/api\/runtimes\/:id\/claude-profile$/, "runtime.claude-profile.set"],
